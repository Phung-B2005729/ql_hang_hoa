...
class CuaHangService extends GetConnect {
  // hàm create
  CuaHangService() {
    httpClient.baseUrl = "${AppConfig.urlApi}/cua_hang";
  ...
  // hàm create
  Future<Response> create(CuaHangModel cuaHang) async {
    try {
      var body = cuaHang.toJson();
  ...
  Future<Response> update(
      {required String id, required CuaHangModel cuaHang}) async {
    var body = cuaHang.toJson();
