...
class TimKiemCuaHangScreen extends GetView<CuaHangController> {
  TimKiemCuaHangScreen({super.key});
                                  ...
                                  Obx(
                                    () => GestureDetector(
                                        onTap: () async {
                                          ...
                                          await controller.getOneCuaHang(
                                              controller.filteredList[index]
                                                      .maCuaHang ??
                                                  '');
                                          Get.to(
                                              () => XemChiTietCuaHangScreen());
                                        },
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                          borderSide: const BorderSide(
                              color: Color.fromARGB(255, 64, 64, 64), width: 1),
                          borderRadius: BorderRadius.circular(15)),
                      hintText: 'Mã, tên, sdt, địa chỉ cửa hàng',
